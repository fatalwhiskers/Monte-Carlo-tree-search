/** \file HighestReward.h
* Header file for the HighestReward class.
*/

#ifndef HIGHESTREWARD_H
#define HIGHESTREWARD_H
...
#include "node.h"
#include <iostream>
//! The HighestReward class

/*!
This class contains the HighestReward program.
*/
	...
	*/
	move runTree(tState rootstate, int iterations)
	{
		...
		for (int i = 0; i < iterations; i++)
		{
			...
			{
				//select child
				nod = nod->selectHighestRewardChild();
